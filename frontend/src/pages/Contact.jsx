              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    className="text-orange-500 hover:text-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-900 rounded transition-colors cursor-pointer"
                  >
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    className="w-12 h-12 bg-zinc-900 hover:bg-orange-500 text-zinc-400 hover:text-zinc-950 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-all duration-300 cursor-pointer"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full p-4 bg-zinc-950 border-2 border-zinc-800 text-white focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    id="message"
                    className="w-full p-4 bg-zinc-950 border-2 border-zinc-800 text-white focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-colors resize-none h-40"
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-orange-500 text-zinc-950 font-bold text-lg uppercase tracking-wider hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  disabled={loading}
                >
                  {loading ? (
