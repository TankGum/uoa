...
function Footer() {
  ...
  return (
    <footer className="relative mt-auto bg-zinc-950 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="text-center md:text-left">
            <div className="mb-6">
              ...
              <div className="h-1 w-20 bg-orange-500 mx-auto md:mx-0"></div>
              <p className="text-sm font-medium text-orange-500 uppercase tracking-widest mt-2">
                Production
              </p>
            </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="space-y-4 mb-6">
              <p className="text-zinc-400 text-sm">
                <span className="text-orange-500 font-bold">Email:</span><br />
            ...
            <div className="flex justify-center md:justify-end gap-4">
              <a 
                ...
                className="w-12 h-12 bg-zinc-900 hover:bg-orange-500 text-zinc-400 hover:text-zinc-950 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-zinc-950 transition-all duration-300 group cursor-pointer"
      ...
      {/* Bottom Orange Strip */}
      <div className="relative h-1 bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600">
