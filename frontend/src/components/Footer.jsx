          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end gap-4">
              <a 
                ...
                className="w-12 h-12 bg-zinc-900 hover:bg-orange-500 text-zinc-400 hover:text-zinc-950 flex items-center justify-center transition-all duration-300 group"
                aria-label="Facebook"
              >
